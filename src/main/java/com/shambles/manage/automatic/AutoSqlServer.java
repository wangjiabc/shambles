package com.shambles.manage.automatic;
...
public class AutoSqlServer { 
	//包名
	private String packageName="package com.shambles.manage.daoModel.TTT;\n\n";
    ...
    private String parse(String dataBase,String tabName,String[] colNames,String[] colType,int[] colSize){  
        ...
        sb.append("import com.shambles.manage.daoSQL.annotations.*;\n\n");
