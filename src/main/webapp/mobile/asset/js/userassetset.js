	...
	$('.name input').focus(function(){
	 ...
	 $('.name input').blur(function(){
	     var reque=$('.name input')[0].value;
	   	$.post('/shambles/mobile/assetRegister/testName.do',{
	   	   name:reque
	   	   },function(text){ 
	 ...
	 $('.phone input').blur(function(){
	     var reque=$('.phone input')[0].value;
	   	$.post('/shambles/mobile/assetRegister/testPhone.do',{
	   		telephone:reque
	   	   },function(text){ 
	   		var obj=JSON.parse(text);
			 data=obj.data;
	 ...
	 $('.IDNo input').blur(function(){
	     var reque=$('.IDNo input')[0].value;
	   	$.post('/shambles/mobile/assetRegister/testIDNo.do',{
	   		IDNo:reque
	   	   },function(text){ 
	   		var obj=JSON.parse(text);
			 data=obj.data;
	 ...
	 $.post('/shambles/mobile/assetRegister/userAssetByopenId.do', {
			campusId:campusId
	       },function(data){
