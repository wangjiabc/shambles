			    	 ...
			    	 wx.ready(function () {
			    		 ...
			    		 $('.name input').blur(function(){
			    		     var reque=$('.name input')[0].value;
			    		   	$.post('/shambles/mobile/register/testName.do',{
			    		   	   name:reque
			    		   	   },function(text){ 
			    		 ...
			    		 $('.phone input').blur(function(){
			    		     var reque=$('.phone input')[0].value;
			    		   	$.post('/shambles/mobile/register/testPhone.do',{
			    		   		telephone:reque
			    		   	   },function(text){ 
			    		   		var obj=JSON.parse(text);
			    				 data=obj.data;
			    		 ...
			    		 $('.email input').blur(function(){
			    		     var reque=$('.email input')[0].value;
			    		   	$.post('/shambles/mobile/register/testEmail.do',{
			    		   		email:reque
			    		   	   },function(text){ 
			    		   		var obj=JSON.parse(text);
			    				 data=obj.data;
			    			...
			    			if(valid1==false||valid2==false||valid3==false){
			    			 ...
			    			 var regtlx=document.getElementById("regtlx").value;
	 			    			if(campusId!=null&&typeof(campusId)!="undefined"){
	 			    				$.post('/shambles/mobile/register/insert.do', {
	 			    					name:name,
	 			    					headship:headship,
	 			    					phone:phone,
	 			    					email:email,
